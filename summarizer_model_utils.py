...
def sample_results(preds, ind2word, word2ind, converted_texts, use_bleu=False):
    ...
    for pred, text, seq_length in zip(preds[0], converted_texts,
                                               [len(inds) for inds in converted_texts]):
        print('\n\n\n', 100 * '-')
        if beam:
